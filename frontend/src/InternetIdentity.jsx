  ...
  return (
    <div className="flex items-center space-x-4">
      {isAuthenticated ? (
        ...
        <button
          onClick={login}
          className="transform rounded-lg bg-infinite hover:bg-white px-6 py-2 text-sm font-bold text-white hover:text-blue-600 shadow-md transition duration-300 ease-in-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50"
        >
          Sign In
        </button>
      )}
